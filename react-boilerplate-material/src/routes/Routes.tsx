...
const BankStatementUpload = lazy(() => import('features/BankStatementUpload'));

const routesConfig: IRoutes[] = [
  {
    exact: true,
    path: '/',
    component: () => <Redirect to={PATH_NAME.SUBSCRIPTIONS} />,
  },
  {
    exact: true,
  ...
  },
  {
    ...
    routes: [
      {
        exact: true,
        path: PATH_NAME.SUBSCRIPTIONS,
        component: Subscriptions,
        // requireRoles: [USER_ROLE.ADMIN, USER_ROLE.LEAD],
      },
      {
        exact: true,
        path: PATH_NAME.BANK_STATEMENT_UPLOAD,
